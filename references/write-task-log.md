...
Do not assign record numbers, update the current-task sentinel, create scratch input, or fetch timestamps separately. Lookup helpers are for handoff/resume, summarization, or explicit history questions, not normal writes.
