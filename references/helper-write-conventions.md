...
- Put fallback input files in the operating system temp directory. Helpers delete `--input` files after reading them when the resolved file path is under the OS temp directory.
