...
const { booleanArg, DEFAULT_UNSUPPORTED_OPERATION_FLAGS, localTimestamp, resolveRootPath, runCli, sanitizeSlug } = require("./lib/helper-common");
...
const REQUIRED_ONE_OF = [["member", "latest", "query"]];
...
runCli(main, {
  ...
  stringFlags: ["root", "project-id", "user-root", "input", "member", "query", "append"],
